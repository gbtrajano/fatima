...
export default function Services() {
  return (
    <section
      className="bg-linear-to-r from-[#193725] via-[#2b573d] to-[#193725] flex items-center justify-center h-auto"
      id="services-section"
    >
      <div className="flex items-center gap-4 flex-col md:flex-row py-10">
        <Link href="/work">
          <div className="relative hover:cursor-pointer scale-95">
